 ...
 */
package com.corporate.contusfly_corporate.utils;
...
import com.corporate.contusfly_corporate.emoji.Emojicon;
import com.corporate.contusfly_corporate.emoji.EmojiconGridView;
...
import com.corporate.contusfly_corporate.model.PendingNotification;
...
import com.corporate.contusfly_corporate.views.RoundedCornersTransformation;
...
public class Utils {
    ...
    public static class ContactSync extends AsyncTask<Void, Void, String> {
        ...
        public ContactSync(Context context, String deviceCountryCode) {
            this.context = context;
            phoneCode = MApplication.getString(context, com.corporate.contus_Corporate.app.Constants.PHONE_NUMBER_CODE);
...
*/
    ...
    public void createNotification(MApplication mApplication, Context context, String title,
        ...
        try {
            ...
            int messageCounts = Integer.parseInt(mApplication.getStringFromPreference(com.corporate.contus_Corporate.app.Constants.GET_MESSAGE_UNREAD_COUNT)) + 1;
            MApplication.storeStringInPreference(com.corporate.contus_Corporate.app.Constants.GET_MESSAGE_UNREAD_COUNT, String.valueOf(messageCounts));
