...
import com.corporate.contusfly_corporate.adapters.AdapterContactsInfo;
import com.corporate.contusfly_corporate.chooseContactsDb.ChooseContactsModelClass;
...
public class ContactDisplay extends ActivityBase implements
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
       ...
       db=new DatabaseHelper(mContactDisplay);
        ...
        mContactTitle = MApplication.loadStringArray(mContactDisplay, mCategory, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE);
    ...
    private void setControls() {
        try {
            ...
            mContactName = mApplication.loadStringArray(mContactDisplay, mContactName, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CONTACT_NAME_INFO, com.corporate.contus_Corporate.app.Constants.ACTIIVTY_CONTACT_NAME_INFO_SIZE);
            mArrayList = mApplication.loadStringArray(mContactDisplay, mArrayList, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CONTACT_INFO, com.corporate.contus_Corporate.app.Constants.ACTIIVTY_CONTACT_INFO_SIZE);
