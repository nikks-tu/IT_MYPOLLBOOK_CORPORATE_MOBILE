...
import com.corporate.contusfly_corporate.adapters.AdapterGroupInfo;
...
public class GroupDisplay extends ActivityBase implements
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContactTitle = MApplication.loadStringArray(groupInfoActivity, mCategory, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE);
        ...
        try {
            ...
            ItemClickSupport.addTo(listMembers).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    mArrayList = mApplication.loadStringArray(groupInfoActivity, mArrayList, com.corporate.contus_Corporate.app.Constants.ACTIVITY_GROUP_INFO, com.corporate.contus_Corporate.app.Constants.ACTIIVTY_GROUP_INFO_SIZE);
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_create:
                ...
                if(!checkedIds.isEmpty()) {
                    ...
                    mApplication.saveStringArray(groupInfoActivity, mCategory, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CATEGORY_INFO_SIZE);
                }
