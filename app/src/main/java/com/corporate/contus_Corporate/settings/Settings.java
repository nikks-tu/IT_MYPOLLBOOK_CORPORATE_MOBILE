package com.corporate.contus_Corporate.settings;
...
import com.corporate.contus_Corporate.activity.Welcome;
import com.corporate.contus_Corporate.responsemodel.DeleteResponseModel;
import com.corporate.contus_Corporate.restclient.DeleteAccount;
...
//chooses and keeps the selected item as a uri
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        userId = MApplication.getString(getActivity(), com.corporate.contus_Corporate.app.Constants.USER_ID);
        phoneNumber = MApplication.getString(getActivity(), com.corporate.contus_Corporate.app.Constants.PHONE_NUMBER);
        phoneCode = MApplication.getString(getActivity(), com.corporate.contus_Corporate.app.Constants.PHONE_NUMBER_CODE);
                    ...
                    , new Callback<DeleteResponseModel>() {
                        ...
                        public void success(DeleteResponseModel deleteResponseModel, Response response) {
                            if (("1").equals(deleteResponseModel.getSuccess())) {
                                MApplication.setBoolean(getActivity(), com.corporate.contus_Corporate.app.Constants.FIRST_TIME, false);
                                //delete the record
