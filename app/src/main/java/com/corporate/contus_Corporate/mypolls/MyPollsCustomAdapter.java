package com.corporate.contus_Corporate.mypolls;
...
import com.corporate.contus_Corporate.likes.PollLikes;
import com.corporate.contus_Corporate.responsemodel.LikeUnLikeResposneModel;
import com.corporate.contus_Corporate.responsemodel.PollDeleteResponseModel;
import com.corporate.contus_Corporate.responsemodel.PollParticipateResponseModel;
import com.corporate.contus_Corporate.responsemodel.UserPollResponseModel;
import com.corporate.contus_Corporate.restclient.LikesAndUnLikeRestClient;
import com.corporate.contus_Corporate.restclient.PollDelete;
import com.corporate.contus_Corporate.restclient.PollParticipateRestClient;
import com.corporate.contus_Corporate.userpolls.FullImageView;
import com.corporate.contus_Corporate.views.EndLessListView;
import com.corporate.contus_Corporate.views.VideoLandscapeActivity;
...
public class MyPollsCustomAdapter extends ArrayAdapter<UserPollResponseModel.Results.Data> {
    ...
    public View getView(final int position, View mView, ViewGroup parent) {
        ...
        if (Integer.parseInt(idRefrenceView) == Constants.LAYOUT_ONE) {
            ...
            holderMyPollView1.imgShareYesOrNoMyPOll.setVisibility(View.GONE);
          ...
          //  holderMyPollView1.imgShareYesOrNoMyPOll.setImageDrawable(myPollActivity.getResources().getDrawable(R.drawable.arrow_down));
            ...
            holderMyPollView2.imgShareMultipleOptionsMyPoll.setVisibility(View.GONE);
            ...
            holderMyPollView3.imgSharePhotoComparisonMyPoll.setVisibility(View.GONE);
            ...
            holderMyPollView4.imgShareYouTubeUrlMyPoll.setVisibility(View.GONE);
    ...
    public void showAlertDialog(final int mClickPosition, String msg, String positiveString, String negativeString) {
        ...
        builder.setTitle("Alert");//set message
