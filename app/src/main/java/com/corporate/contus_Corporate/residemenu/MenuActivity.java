package com.corporate.contus_Corporate.residemenu;
...
import com.corporate.contus_Corporate.aboutus.AboutUs;
import com.corporate.contus_Corporate.app.Constants;
import com.corporate.contus_Corporate.category.Category;
import com.corporate.contus_Corporate.category.IFragmentReplace;
import com.corporate.contus_Corporate.contactus.ContactUs;
import com.corporate.contus_Corporate.mypolls.MyPolls;
import com.corporate.contus_Corporate.myprofile.EditProfile;
import com.corporate.contus_Corporate.myprofile.MyProfile;
import com.corporate.contus_Corporate.publicpoll.PublicPoll;
import com.corporate.contus_Corporate.restclient.UserPollRestClient;
import com.corporate.contus_Corporate.search.SearchActivity;
import com.corporate.contus_Corporate.settings.Settings;
import com.corporate.contus_Corporate.userpolls.UserPolls;
import com.corporate.contusfly_corporate.MApplication;
import com.corporate.contusfly_corporate.chat.HomeChat;
import com.corporate.contusfly_corporate.chooseContactsDb.DatabaseHelper;
import com.corporate.contusfly_corporate.createpoll.MultipleOptions;
import com.corporate.contusfly_corporate.createpoll.PhotoComparison;
import com.corporate.contusfly_corporate.createpoll.YesOrNo;
import com.corporate.contusfly_corporate.fragments.FragmentContacts;
import com.corporate.contusfly_corporate.fragments.FragmentRecentChats;
import com.corporate.contusfly_corporate.model.PollUnseenStatusModel;
import com.corporate.contusfly_corporate.utils.Utils;
import com.corporate.contusfly_corporate.views.CircularImageView;
import com.corporate.new_chanages_corporate.fragments.Announcements;
...
public class MenuActivity extends AppCompatActivity implements FragmentManager.OnBackStackChangedListener, IFragmentReplace, View.OnClickListener, MyPolls.MyPollsOnInteractionListner, UserPolls.UserPollOnFragmentInteractionListner, PublicPoll.CampaignPollInteractionListner {
  ...
  //  private ResideMenuItem itemFeedback;
    ...
    private TextView announcementtext,anoctext;
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        anoctext=findViewById(R.id.anouncetext);
        ...
        anoctext.setTypeface(faceRegular);
        announcementtext.setTypeface(faceRegular);
       ...
       // Typeface faceRegular = Typeface.createFromAsset(getAssets(), "fonts/Quicksand-Regular.otf");
        ...
        if (savedInstanceState == null) {
            ...
            if (MApplication.getBoolean(this, "notification click")) {
                ...
                mTitle.setText("Department Polls");
            }
            //visibility gone
        ...
        String getBatchCount = mApplication.getStringFromPreference(com.corporate.contus_Corporate.app.Constants.GET_MESSAGE_UNREAD_COUNT);
        if (TextUtils.isEmpty(getBatchCount)) {
            mApplication.storeStringInPreference(com.corporate.contus_Corporate.app.Constants.GET_MESSAGE_UNREAD_COUNT, "0");
        }
    ...
    private void setUpMenu() {
        ...
        itemHome = new ResideMenuItem(this, R.drawable.ic_userpoll_gray, getResources().getString(R.string.activity_home),false);
  ...
  //      resideMenu.addMenuItem(itemFeedback, ResideMenu.DIRECTION_LEFT);
    ...
    public void onClickSpinner(View view) {
        ...
        MApplication.saveStringArray(MenuActivity.this, listGroupid, com.corporate.contus_Corporate.app.Constants.ACTIVITY_GROUP_INFO, Constants.ACTIIVTY_GROUP_INFO_SIZE);
        ...
        MApplication.saveStringArray(MenuActivity.this, mContactName, com.corporate.contus_Corporate.app.Constants.ACTIVITY_CONTACT_NAME_INFO, com.corporate.contus_Corporate.app.Constants.ACTIIVTY_CONTACT_NAME_INFO_SIZE);
        MApplication.saveStringArray(MenuActivity.this, mGroupName, com.corporate.contus_Corporate.app.Constants.ACTIVITY_GROUP_NAME_INFO, com.corporate.contus_Corporate.app.Constants.ACTIVITY_GROUP_NAME_INFO_SIZE);
    ...
    public void onClickButton(View view) {
        ...
        if (view.getId() == R.id.ll_department_poll) {
                    ...
                    , new Callback<PollUnseenStatusModel>() {
                        ...
                        public void success(PollUnseenStatusModel userPollResponseModel, Response response) {
                            if (userPollResponseModel.getResponseCode().equals("200")) {
                                ...
                                announcementtext.setTextColor(getResources().getColor(R.color.grey_color));
            ...
            search_et.setText("");
            anoctext.setTextColor(getResources().getColor(R.color.text_colore_blue));
            userpolltext.setTextColor(getResources().getColor(R.color.grey_color));
            //view visible
            frame1.setVisibility(View.GONE);
            //public poll
            imageChangeFragment(new Announcements());
    ...
    public void onClick(View view) {
        ...
        if (view == itemHome) {
            ...
            layoutTop.setVisibility(View.GONE);
            //setting the text`
            txtTitle.setText("Department Polls");
            //View visible
            btnCreatePoll.setVisibility(View.VISIBLE);
            //View visible
            imgMore.setVisibility(View.GONE);
        ...
        if (view == itemProfile) {
            ...
            if (imgProfile.getVisibility() == View.VISIBLE) {
                ...
                imageAddComments.setBackgroundResource(R.drawable.splash_screen_new_crop);
                //view invisible
                frame1.setVisibility(View.GONE);
                //text view done
                bDone.setVisibility(View.GONE);
                ...
                //This view containns only create poll icon
   ...
   /* if("yes".equalsIgnoreCase(fromActivity)){
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
        ...
        exitToast = Toast.makeText(getApplicationContext(), "Press back again to exit PollBook", Toast.LENGTH_SHORT);
    ...
    private void navigateBackPressed(Fragment currFrag) {
        ...
        else if(selectedTag.equals(Announcements.class.getName()))
        {
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative
            relative = (RelativeLayout) itemHome.findViewById(R.id.relative);
            //title set text color
            title.setTextColor(getResources().getColor(R.color.helvetica_light_greycolor));
            //icon set text color
            icon.setColorFilter(getResources().getColor(R.color.helvetica_light_greycolor));
        ...
        if (selectedTag.equals(Category.class.getName())) {
            ...
            // Default fragment
            //title
            title = (TextView) itemCategories.findViewById(R.id.tv_title);
            //icon
            icon = (ImageView) itemCategories.findViewById(R.id.iv_icon);
            //divider line
            dividerLine = itemCategories.findViewById(R.id.view);
            //setting the text color
            title.setTextColor(getResources().getColor(R.color.blue_color));
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative = (RelativeLayout) itemCategories.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
        ...
        if (selectedTag.equals(MyPolls.class.getName())) {
            ...
            MApplication.setBoolean(this, "createpoll", false);
            //title
            title = (TextView) itemMyPolls.findViewById(R.id.tv_title);
            //icon
            icon = (ImageView) itemMyPolls.findViewById(R.id.iv_icon);
            //divider line
            dividerLine = itemMyPolls.findViewById(R.id.view);
            //setting the text color
            title.setTextColor(getResources().getColor(R.color.blue_color));
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative = (RelativeLayout) itemMyPolls.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
...
//                Utils.loadImageWithGlideSingleImageRounderCorner(mContext, imageUrl, imgProfile, R.drawable.img_ic_user);
                ...
                MApplication.setBoolean(this, "createpoll", false);
                //title
                title = (TextView) itemProfile.findViewById(R.id.tv_title);
                //icon
                icon = (ImageView) itemProfile.findViewById(R.id.iv_icon);
                //divider line
                dividerLine = itemProfile.findViewById(R.id.view);
                //setting the text color
                title.setTextColor(getResources().getColor(R.color.blue_color));
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative = (RelativeLayout) itemProfile.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
        if (selectedTag.equals(Category.class.getName())) {
...
/*
        ...
        if (selectedTag.equals(AboutUs.class.getName())) {
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative = (RelativeLayout) itemAboutUs.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
     ...
     /*   if (selectedTag.equals(Feedback.class.getName())) {
        ...
        if (selectedTag.equals(ContactUs.class.getName())) {
            ...
            //title
            title = (TextView) itemContactUs.findViewById(R.id.tv_title);
            //icon
            icon = (ImageView) itemContactUs.findViewById(R.id.iv_icon);
            //divider line
            dividerLine = itemContactUs.findViewById(R.id.view);
            //setting the text color
            title.setTextColor(getResources().getColor(R.color.blue_color));
            ...
            dividerLine.setVisibility(View.INVISIBLE);
            //relative layout
            relative = (RelativeLayout) itemContactUs.findViewById(R.id.relative);
            //set background color
            relative.setBackgroundColor(getResources().getColor(R.color.background_color));
        }
    }
