...
import com.corporate.contus_Corporate.restclient.MobileNumberCheckRestClient;
...
public class RegisterActivity extends Activity implements Constants, Utils.ContactResult {
    ...
    private void smsGateWayResponse(SMSgatewayResponseModel smsGateWayResponse) {
       ...
       /* if (("0").equals(smsGateWayResponse.getSuccess())) {
        ...
        /* Starting the activity **/
        startActivityForResult(a, com.corporate.contusfly_corporate.utils.Constants.ACTIVITY_REQ_CODE);
        /* }*/
    }
    ...
    private void checkMobileNumberResponse(MobileNumberChange mobileNumberChange) {
        ...
        if (("1").equals(success) && ("0").equals(mobileKey)) {
            ...
            //setting the string
            MApplication.setString(RegisterActivity.this, com.corporate.contusfly_corporate.utils.Constants.VIBRATION_TYPE,
                    "0");
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (("1").equals(clickValue)) {
                    ...
                    MApplication.setBoolean(mRegisterActivity, com.corporate.contus_Corporate.app.Constants.FIRST_TIME, true);
