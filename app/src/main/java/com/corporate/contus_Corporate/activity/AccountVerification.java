...
package com.corporate.contus_Corporate.activity;
...
import com.corporate.contus_Corporate.residemenu.MenuActivity;
import com.corporate.contus_Corporate.responsemodel.ContactResponseModel;
import com.corporate.contus_Corporate.responsemodel.MobileNumberChange;
import com.corporate.contus_Corporate.responsemodel.SMSgatewayResponseModel;
import com.corporate.contus_Corporate.responsemodel.SMSverifyModel;
import com.corporate.contus_Corporate.restclient.ContactsRestClient;
import com.corporate.contus_Corporate.restclient.SMSVerifyRestClient;
import com.corporate.contus_Corporate.restclient.SMSgatewayRestClient;
import com.corporate.contusfly_corporate.MApplication;
import com.corporate.contusfly_corporate.activities.ActivityBase;
import com.corporate.contusfly_corporate.service.ChatService;
...
import com.corporate.contusfly_corporate.views.CustomToast;
import com.corporate.new_chanages_corporate.api_interface.CheckOtpDataInterface;
...
public class AccountVerification extends ActivityBase implements Constants,Utils.ContactResult  {
    ...
    /** The m application. */
    private com.corporate.contusfly_corporate.MApplication mAccountVerificationApplication;
    ...
    private void init() {
        ...
        mAccountVerificationApplication = (com.corporate.contusfly_corporate.MApplication) getApplication();
   ...
   /* private void checkMobileNumber() {
    ...
    private void checkMobileNumberResponse(MobileNumberChange mobileNumberChange) {
        ...
        if (("1").equals(success) && ("0").equals(mobileKey)) {
            ...
            startActivityForResult(intent, com.corporate.contusfly_corporate.utils.Constants.ACTIVITY_REQ_CODE);
        } else if (("2").equals(success) && ("1").equals(mobileKey)) {
            //setting the string
            MApplication.setString(AccountVerification.this, com.corporate.contusfly_corporate.utils.Constants.VIBRATION_TYPE,
                    "0");
            /*Toast message is displayed when the following field is empty**/
            String clickValue = "1";
           ...
           password=mobileNumberChange.getResults().getPassword();
            ...
            mAccountVerificationApplication.storeBooleanInPreference(com.corporate.contusfly_corporate.utils.Constants.IS_CONTACTS_SYNCED, true);
            //saving in preference
            mAccountVerificationApplication.storeStringInPreference(com.corporate.contusfly_corporate.utils.Constants.USERNAME,phoneCode + phoneNumber);
            //saving in preference
            ...
            public void onClick(View v) {
                if (("1").equals(clickValue)) {
                   ...
                   MApplication.materialdesignDialogStart(mAccountVerification);
                    ...
                    MApplication.setBoolean(mAccountVerification, com.corporate.contus_Corporate.app.Constants.FIRST_TIME, true);
    ...
    protected void handleLoggedIn() {
        ...
        if(MApplication.getBoolean(mAccountVerification,"test")) {
            try {
                mAccountVerificationApplication.storeStringInPreference(com.corporate.contusfly_corporate.utils.Constants.USERNAME, phoneCode + phoneNumber);
                mAccountVerificationApplication.storeStringInPreference(com.corporate.contusfly_corporate.utils.Constants.SECRET_KEY, password);
                mAccountVerificationApplication.storeStringInPreference(com.corporate.contusfly_corporate.utils.Constants.USER_STATUS,
                        getString(R.string.default_status));
                mAccountVerificationApplication.storeBooleanInPreference(com.corporate.contusfly_corporate.utils.Constants.IS_LOGGED_IN, true);
                mAccountVerificationApplication.storeStringInPreference(com.corporate.contusfly_corporate.utils.Constants.CHAT_ONGOING_NAME,
                        com.corporate.contusfly_corporate.utils.Constants.NULL_VALUE);
