package com.corporate.new_chanages_corporate;
...
import com.corporate.new_chanages_corporate.adapters.LikedListAdapter;
...
public class AnnouncementLikes_actvty extends AppCompatActivity {
    ...
    public void getAnnouncement_list(final boolean more)
    {
        ...
        CustomRequest.makeJsonObjectRequest(getApplicationContext(), Constants.ANNOUNCEMNET_LIKES,obj, new VolleyResponseListener() {
            @Override
